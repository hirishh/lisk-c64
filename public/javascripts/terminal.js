...
var Terminal = (function () {
    ...
    inputField.id = "terminalInput";
		...
		inputField.onkeyup = function (e) {
			if (PROMPT_TYPE === PROMPT_CONFIRM || e.which === 13) {
				...
				if (shouldDisplayInput) terminalObj.print(inputValue, true)
	...
	var TerminalConstructor = function (id) {
		if (!terminalBeep) {
			...
			var source = '<source src="/sounds/beep.'
		...
		this._cursor = document.createElement('b')
    this._cursor.className = 'cursor'
		...
		this.print = function (message, withBR) {
			var newLine = document.createElement('div')
			newLine.innerHTML = message
			this._output.appendChild(newLine)
      if(withBR) this._output.appendChild(document.createElement('br'))
		}
    ...
    // this._cursor.style.background = 'white'
		this._cursor.innerHTML = 'H' //put something in the cursor..
